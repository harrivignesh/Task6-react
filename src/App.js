  ...
  return (
    <div className="App">
      <header className="header bg-primary text-white py-5 text-center">
        <h1 className="name">HARRI VIGNESH</h1>
      ...
      <section className="contact py-5 bg-primary text-white">
        <div className="container">
          ...
          <p>LinkedIn: <a href="https://www.linkedin.com/in/harri-vignesh-a375b826b/" target="_blank" rel="noopener noreferrer">LinkedIn Profile</a></p>
          <p>GitHub: <a href="https://github.com/harrivignesh" target="_blank" rel="noopener noreferrer">GitHub Profile</a></p>
        </div>
      </section>
    </div>
  );
